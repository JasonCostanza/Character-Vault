...
| `--cv-module-text-light` | `#E8DCC8` | `#F7EED8` | `#E0E0F0` | `#C8D8E8` | `#F5F5FA` | `#E8D0C8` | Module text override (light) |
| `--cv-module-text-dark` | `#2C1A0E` | `#2C1A0E` | `#12121F` | `#131A24` | `#1A1A2E` | `#1C0E0E` | Module text override (dark) |

---

## CSS Implementation

All color tokens are defined in `css/tokens.css`. Theme switching is done by setting `data-theme` on `<html>`.
